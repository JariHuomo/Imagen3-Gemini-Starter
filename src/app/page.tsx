            ...
            >
              <div className={`relative ${getAspectRatioClass(image.aspectRatio)}`}>
                ...
                <button
                  ...
                  className="absolute top-2 right-2 p-2 rounded-full bg-red-500/80 hover:bg-red-600/80 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10"
